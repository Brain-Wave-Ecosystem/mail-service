module github.com/Brain-Wave-Ecosystem/mail-service

go 1.24.1

require (
	github.com/Brain-Wave-Ecosystem/go-common v0.0.0-20250329221503-67c8019a500f
	github.com/DavidMovas/gopherbox v0.0.0-20250329141646-145b4e0827ef
	github.com/NawafSwe/gomailer v1.0.0
